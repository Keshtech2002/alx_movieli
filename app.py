...
movies = pd.read_pickle(open('./models/movies_list.pkl', 'rb'))
similarity = pd.read_pickle(open('./models/similarity.pkl', 'rb'))

def fetch_poster(movie_id):
    url = "https://api.themoviedb.org/3/movie/{}?api_key=22c75dd7aa1d489232ff6e21c26c997e&language=en-US".format(movie_id)
